...
class ExtraQuerystringMixin(UrlMixin):
    ...
    * extra_querystring_attrs:
    ...
    def __init__(self, extra_querystring_attrs=None, extra_extra_querystring_attrs=None, **kwargs):
        self.extra_querystring_attrs = extra_querystring_attrs or self.extra_querystring_attrs
        self.extra_querystring_attrs.update(
            extra_extra_querystring_attrs or {})
