...
class ModelWrapper(Wrapper):
    ...
    * """
    ...
    def __init__(self, obj=None, model_name=None, key=None, **kwargs):
        ...
        self.add_extra_attributes_before(obj=obj, **kwargs)
        self.wrapped_object = self.model_url_wrapper(obj=obj)
    ...
    def add_extra_attributes_before(self, obj=None, **kwargs):
    ...
    def model_url_wrapper(self, obj=None):
        """Add urls to obj, wrapped object.
        """
        obj = self.object_url_wrapper(key=self.key, obj=obj)
        return obj
